...
public interface VideoService extends IService<Video> {
     ...
     * @param video
     */
    void publishVideo(Video video, Long userId) throws Exception;
     ...
     * @return
     */
    boolean startVideo(Long videoId, Long userId) throws Exception;
     ...
     * @return
     */
    boolean favoritesVideo(Long fId, Long vId, Long uId) throws Exception;
     ...
     * @return
     */
    LinkedHashMap<String, List<Video>> getHistory(BasePage basePage, Long userId);
     ...
     * @return
     */
    Collection<Video> listVideoByFavorites(Long favoritesId, Long userId);
