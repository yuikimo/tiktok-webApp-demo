...
import com.example.tiktok.mapper.user.PermissionMapper;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission> implements PermissionService {
    ...
    public Map<String, Object> initMenu(Long uId) {
        ...
        List<Long> rIds = userRoleService.list(
                                                 new LambdaQueryWrapper<UserRole>().eq(UserRole::getUserId, uId).select(UserRole::getRoleId))
                                         .stream()
        ...
        List<Integer> pIds = rolePermissionService.list(
                                                          new LambdaQueryWrapper<RolePermission>().in(RolePermission::getRoleId, rIds)
