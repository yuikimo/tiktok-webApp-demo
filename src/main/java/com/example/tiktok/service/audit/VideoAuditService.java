...
import com.example.tiktok.entity.json.BodyJson;
import com.example.tiktok.entity.json.ScoreJson;
        ...
        try {
            ...
            while (true) {
                ...
                if (bodyJson.getStatus().equals("FINISHED")) {
                    ...
                    final SettingScoreJson settingScoreRule =
                            objectMapper.readValue(setting.getAuditPolicy(), SettingScoreJson.class);
                    final List<ScoreJson> auditRule =
                            Arrays.asList(settingScoreRule.getManualScore(), settingScoreRule.getPassScore(),
                                          settingScoreRule.getSuccessScore());
